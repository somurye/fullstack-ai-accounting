...
| P3-T3 | 給与計算エンジン | 勤怠実績・基本給・手当・控除から給与を計算し、AI提案パターンで人間確認を経て確定する（5.2節の原則②に対応） | P3-T1, P3-T2 | ✅ SO正式PASS（コミット4e6b0c1、6回の往復を経て確定境界をDB最終防御＋API認証境界の二層構造で完成。mainマージ指示済み） |
